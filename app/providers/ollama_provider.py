...
class OllamaProvider:
    ...
    def _get_memory_context(self, emit: Callable[[str], None] = print):
        ...
        try:
            ...
            # Consolidate memory retrieval into a single database connection for performance
            facts, episodes, rules = memory.get_full_context(
                entity="user", episodic_limit=3
            )
...
if __name__ == "__main__":
    ...
    # Test tool usage
    test_messages = [
        {"role": "user", "content": "What time is it and what is 123 + 456?"}
    ]
